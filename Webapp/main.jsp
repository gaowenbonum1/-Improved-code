...
<script type="text/javascript">
	var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎交院聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
	var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临交院聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
...
<body style="background-image: url('images/fengjing.jpg');background-size:100% 100%">
	...
	<table  width="100%" height="455 border="0" align="center"
		...
		<tr>
			<td style="background-image: url('images/luxun.jpg');background-size:100% 100%;" width="165" valign="top" bgcolor="#f6fded" id="online"
				style="padding: 5px">在线人员列表</td>
			<td width="613" height="200px" valign="top"
				background="images/main_bj.jpg" bgcolor="#FFFFFF"
				style="padding: 5px;">
				<div>
				<div style="display:inline-block;height: 410px; width:600px; overflow: hidden " id="content">聊天内容</div>
				<div style="display:inline-block; margin-left:10px; height: 410px; overflow: auto " >图片资源待定</div>
				</div>
			</td>
		...
		<form action="" id="form1" name="form1" method="post">
			...
			<tr>
				...
				<input name="from" type="hidden"
					value="${existUser.username}">[${existUser.username} ]对 
				...
				<td width="189" align="left">&nbsp;&nbsp;字体颜色： <select
					name="color" size="1" class="wenbenkuang" id="select">
						...
						<option style="color: #990000" value="990000">紫黑色</option>
						...
						<option style="color: #ff0099" value="ff0099">粉色</option>
				...
				<td width="19" align="left"><input name="scrollScreen"
					...
					onClick="checkScrollScreen()" value="1" checked></td>
			</tr>
			<tr>
